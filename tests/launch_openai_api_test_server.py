...
if __name__ == "__main__":
    ...
    launch_process("python3 -m startchat.serve.controller")
    launch_process("python3 -m startchat.serve.openai_api_server")
    ...
    if args.multimodal:
        ...
        models = [
            ...
            ("lmsys/startchat-t5-3b-v1.0", "model_worker"),
    ...
    for i, (model_path, worker_name) in enumerate(models):
        cmd = (
            f"CUDA_VISIBLE_DEVICES={i} python3 -m startchat.serve.{worker_name} "
