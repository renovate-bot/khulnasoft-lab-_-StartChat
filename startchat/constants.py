...
INPUT_CHAR_LEN_LIMIT = int(os.getenv("STARTCHAT_INPUT_CHAR_LEN_LIMIT", 12000))
...
CONTROLLER_HEART_BEAT_EXPIRATION = int(
    os.getenv("STARTCHAT_CONTROLLER_HEART_BEAT_EXPIRATION", 90)
)
WORKER_HEART_BEAT_INTERVAL = int(os.getenv("STARTCHAT_WORKER_HEART_BEAT_INTERVAL", 45))
WORKER_API_TIMEOUT = int(os.getenv("STARTCHAT_WORKER_API_TIMEOUT", 100))
WORKER_API_EMBEDDING_BATCH_SIZE = int(
    os.getenv("STARTCHAT_WORKER_API_EMBEDDING_BATCH_SIZE", 4)
)
