...
Usage:
python3 -m startchat.data.optional_clean --in input.json --out output.json --keep-lang en
python3 -m startchat.data.optional_clean --in input.json --out output.json --skip-lang en
