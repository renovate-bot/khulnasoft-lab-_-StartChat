...
To make sure StartChat loads the correct prompt template, see the supported models and how to add a new model [here](../../docs/model_support.md#how-to-support-a-new-model).
...
python3 -m startchat.serve.vllm_worker --model-path [MODEL-PATH]
