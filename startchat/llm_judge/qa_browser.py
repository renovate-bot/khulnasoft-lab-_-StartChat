...
from startchat.llm_judge.common import (
    load_questions,
    load_model_answers,
...
def build_demo():
    ...
    with gr.Blocks(
        ...
        gr.Markdown(
            """
# MT-Bench Browser
The code to generate answers and judgments is at [startchat.llm_judge](https://github.com/khulnasoft-lab/StartChat/tree/main/startchat/llm_judge).
"""
        )
