...
from startchat.serve.monitor.basic_stats import NUM_SERVERS
from startchat.serve.monitor.clean_battle_data import (
    to_openai_format,
    replace_model_name,
)
from startchat.utils import detect_language
...
def get_log_files(max_num_files=None):
    ...
    for d in dates:
        for i in range(NUM_SERVERS):
            name = os.path.expanduser(f"~/startchat_logs/server{i}/{d}-conv.json")
