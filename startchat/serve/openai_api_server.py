...
Usage:
python3 -m startchat.serve.openai_api_server
"""
import asyncio
import argparse
import json
...
from startchat.conversation import Conversation, SeparatorStyle
from startchat.protocol.openai_api_protocol import (
...
from startchat.protocol.api_protocol import (
    APIChatCompletionRequest,
    APITokenCheckRequest,
    APITokenCheckResponse,
    APITokenCheckResponseItem,
)
from startchat.utils import build_logger
...
app = fastapi.FastAPI()
headers = {"User-Agent": "StartChat API Server"}
...
def create_openai_api_server():
    parser = argparse.ArgumentParser(
        description="StartChat ChatGPT-Compatible RESTful API server."
    )
