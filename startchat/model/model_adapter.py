...
from startchat.constants import CPU_ISA
from startchat.conversation import Conversation, get_conv_template
from startchat.model.compression import load_compress_model
from startchat.model.llama_condense_monkey_patch import replace_llama_with_condense
from startchat.model.model_chatglm import generate_stream_chatglm
from startchat.model.model_codet5p import generate_stream_codet5p
from startchat.model.model_falcon import generate_stream_falcon
from startchat.model.model_yuan2 import generate_stream_yuan2
from startchat.model.model_exllama import generate_stream_exllama
from startchat.model.model_xfastertransformer import generate_stream_xft
from startchat.model.monkey_patch_non_inplace import (
    replace_llama_attn_with_non_inplace_operations,
)
from startchat.modules.awq import AWQConfig, load_awq_quantized
from startchat.modules.exllama import ExllamaConfig, load_exllama_model
from startchat.modules.xfastertransformer import load_xft_model, XftConfig
from startchat.modules.gptq import GptqConfig, load_gptq_quantized
from startchat.utils import get_gpu_memory
...
def load_model(
    ...
    if os.environ.get("STARTCHAT_USE_MODELSCOPE", "False").lower() == "true":
...
def get_generate_stream_function(model: torch.nn.Module, model_path: str):
    ...
    from startchat.serve.inference import generate_stream
...
class GoogleT5Adapter(BaseModelAdapter):
    """The model adapter for google/Flan based models, such as Salesforce/codet5p-6b, lmsys/startchat-t5-3b-v1.0, flan-t5-*, flan-ul2"""

    def match(self, model_path: str):
        return any(
            model_str in model_path.lower()
            for model_str in ["flan-", "startchat-t5", "codet5p"]
        )
...
class RwkvAdapter(BaseModelAdapter):
    ...
    def load_model(self, model_path: str, from_pretrained_kwargs: dict):
        from startchat.model.rwkv_model import RwkvModel
