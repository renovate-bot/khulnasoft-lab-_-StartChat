...
from startchat.train.train_flant5 import (
    smart_tokenizer_and_embedding_resize,
    make_supervised_data_module,
)

from startchat.train.train_lora import get_peft_state_maybe_zero_3
...
def train():
    ...
    if deepspeed.is_deepspeed_zero3_enabled():
        ...
        # in other mode we use original code from startchat team, to make sure our change is minimum
